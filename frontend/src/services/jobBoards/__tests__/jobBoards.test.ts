...
describe("Indeed URL generation", () => {
  it("encodes spaces and includes location", () => {
    const url = indeedBoard.generateUrl(
      "Junior Software Engineer",
      "Johannesburg",
    );
    expect(url).toBe(
      "https://za.indeed.com/jobs?q=Junior+Software+Engineer&l=Johannesburg",
    );
  });
  ...
  it("handles special characters", () => {
    ...
    expect(url).toBe(
      "https://za.indeed.com/jobs?q=C%2B%2B+Developer&l=Cape+Town",
    );
  });
});
...
describe("LinkedIn URL generation", () => {
  it("uses keywords and location parameters", () => {
    const url = linkedinBoard.generateUrl(
      "Junior Software Engineer",
      "Pretoria",
    );
    expect(url).toBe(
      "https://www.linkedin.com/jobs/search/?keywords=Junior+Software+Engineer&location=Pretoria",
    );
  });
  ...
  it("omits location when not provided", () => {
    ...
    expect(url).toBe(
      "https://www.linkedin.com/jobs/search/?keywords=Graduate+Developer",
    );
  });
});
...
describe("PNet URL generation", () => {
  it("creates a path-based URL with location", () => {
    ...
    expect(url).toBe(
      "https://www.pnet.co.za/jobs/software-testing/in-sandton-or-gauteng?searchOrigin=Resultlist_top-search",
    );
  });
  ...
  it("encodes special characters in title", () => {
    ...
    expect(url).toBe(
      "https://www.pnet.co.za/jobs/c%2b%2b-developer/in-johannesburg?searchOrigin=Resultlist_top-search",
    );
  });
  ...
  it("omits location segment if not provided", () => {
    ...
    expect(url).toBe(
      "https://www.pnet.co.za/jobs/full-stack-developer?searchOrigin=Resultlist_top-search",
    );
  });
});
...
describe("Careers24 URL generation", () => {
  it("creates path-based URL with location", () => {
    const url = careers24Board.generateUrl(
      "Junior Backend Developer",
      "Cape Town",
    );
    expect(url).toBe(
      "https://www.careers24.com/jobs/lc-cape-town/kw-junior-backend-developer/rmt-incl/",
    );
  });
  ...
  it("omits location segment when not provided", () => {
    ...
    expect(url).toBe(
      "https://www.careers24.com/jobs/kw-data-analyst/rmt-incl/",
    );
  });
  ...
  it("handles special characters by removing them", () => {
    ...
    expect(url).toBe(
      "https://www.careers24.com/jobs/lc-johannesburg-cbd/kw-c-developer/rmt-incl/",
    );
  });
});
...
describe("Indeed URL generation – complex cases", () => {
  ...
  it.each([
    ...
    expect(url).toBe(
      `https://za.indeed.com/jobs?q=${expectedQ}&l=${encodeURIComponent(location).replace(/%20/g, "+")}`,
    );
  });
  ...
  it("handles title with ampersand", () => {
    ...
    expect(url).toBe(
      "https://za.indeed.com/jobs?q=Sales+%26+Marketing&l=Durban",
    );
  });
...
describe("LinkedIn URL generation – complex cases", () => {
  ...
  it.each([
    ...
    expect(url).toBe(
      `https://www.linkedin.com/jobs/search/?keywords=${expectedKeywords}&location=${encodeURIComponent(location).replace(/%20/g, "+")}`,
    );
  });
  ...
  it("omits location when not provided", () => {
    ...
    expect(url).toBe(
      "https://www.linkedin.com/jobs/search/?keywords=C%2B%2B+Developer",
    );
  });
  ...
  it("handles special characters in title", () => {
    ...
    expect(url).toBe(
      "https://www.linkedin.com/jobs/search/?keywords=Node.js+Developer&location=Cape+Town",
    );
  });
});
...
describe("PNet URL generation – complex cases", () => {
  it.each([
    ...
    expect(url).toBe(
      `https://www.pnet.co.za/jobs/${expectedSlug}/in-johannesburg?searchOrigin=Resultlist_top-search`,
    );
  });
  ...
  it("handles special characters (C++)", () => {
    ...
    expect(url).toBe(
      "https://www.pnet.co.za/jobs/c%2b%2b-developer/in-cape-town?searchOrigin=Resultlist_top-search",
    );
  });
  ...
  it("handles comma in location", () => {
    ...
    expect(url).toBe(
      "https://www.pnet.co.za/jobs/data-analyst/in-johannesburg-or-gauteng?searchOrigin=Resultlist_top-search",
    );
  });
...
describe("Careers24 URL generation – complex cases", () => {
  it.each([
    ...
    expect(url).toBe(
      `https://www.careers24.com/jobs/lc-johannesburg-cbd/kw-${expectedSlug}/rmt-incl/`,
    );
  });
  ...
  it("strips province from location", () => {
    ...
    expect(url).toBe(
      "https://www.careers24.com/jobs/lc-johannesburg/kw-junior-pa/rmt-incl/",
    );
  });
  ...
  it("removes special characters from title", () => {
    ...
    expect(url).toBe(
      "https://www.careers24.com/jobs/lc-cape-town/kw-c-developer/rmt-incl/",
    );
  });
  ...
  it("handles multiple spaces in title and location", () => {
    ...
    expect(url).toBe(
      "https://www.careers24.com/jobs/lc-johannesburg-cbd/kw-senior-developer/rmt-incl/",
    );
  });
});
